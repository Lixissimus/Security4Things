...
Different phone model may be affected differently by that.
...
When analyzing the number of corrected bits depending on the transmission rate, the following ca be shown:
...
First, the application should stay in calibration and synchronization phase, until the user presses a button.
...
Then the phone is placed on top of them and the application is started.
