...
\iffalse
% this can be deleted later, just to have it in version control
As computers have gotten smaller and less demanding, they were not just used directly anymore, but also embedded into a larger mechanical or technical system (SOURCE!): they enabled new kinds of gadgets or at least improved them dramatically.
\textit{embedded systems} were born.they
\fi

The Internet of Things (IoT)...

- Internet of things is coming
- small connected devices (aka motes) work together to monitor and control from remote
- unconnected embedded system had large impact on daily lives already
- with networking, this impact will become greater
- many possibilities, prospects of success
- but: connected devices have much larger attack surface
- so security becomes way more important
- counter measures within network stack (akes) --> works great
- but: needs to be configured, which hard with limited i/o capabilities

- preloading in fabrics is kinda unsafe
- plugging is sophisticated for normal setups, because many devices involved
