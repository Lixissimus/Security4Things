...
The problem of provisioning (public) keys still remains, too.

In order to secure radio communication, \cite{kuo2007message} utilized a Faraday cage in which a batch of motes can be programmed without interleaving of messages from an attacker outside of the cage.
