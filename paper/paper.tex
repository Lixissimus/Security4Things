...
Thus, leaking of the wireless sent information is less likely.
...
For the Android phone, we implemented two versions of a light emitting application.
We have tested some techniques to make the transmission error-prone.
